...
- 第一二句话: 用主语从句引出图表 what has been widely accepted is that  + 描绘图表 In the diagram sb 1 (定) is doing sth 1 (定 , 状); and / but sb 2 (定) is doing sth 2 (定/状),第一个主体是 要么是 ... 的数量在增加/减少 ,要么是 xx%的多少人在 ,xx%的多少人在
...
first of all, she is a student who is from department of education and have teach experience. In addition, her speaking skill is truly amazing and she have oversea working experience. Last but not least, She enjoy communication with others. I believe she could be a good teacher. So that I sincerely recommend she to you.
