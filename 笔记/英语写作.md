...
​	改造后 :although many  人 fail to pour attention into the phenomenons(尽管许多人没有注意到这个问题)
...
1. 否定词放在句首
   ...
   2. Ont only does he look poor but also in fact keeps poor in his mind.
...
1. 比喻(暗喻)
   ...
   - Sth is serious
     - sth seems to 人
     - As intensive pain is ti the terminally ill patients
...
- 二三四句 : 具体的原因分析
  1. The main element for the problem is that(首先)
...
- 第一二句话: 用主语从句引出图表 what has been widely accepted is that  + 描绘图表 (两个主题两个动作 , 并且这两个主题是确定的): In the cartoon sb 1 (定) is doing sth 1 (定 , 状); and / but sb 2 (定) is doing sth 2 (定/状),第一个主体是 要么是 ... 的数量在增加/减少 ,要么是 xx%的多少人在 ,xx%的多少人在
- 第三句话 : 引出文章中心的过渡语 It is apparent that the author of the drawing tries to reveal to us :
- 第四句 : 文章的中心句 (简单句. 十个单词结束,自己写) ,再用双重否定加工(never fail to  + be )
...
2. 正文
   ...
   1. 第一段
      ...
      1. 自我介绍 
         1. 文中已给出 : I am + 文中给出内容
         2. 文中没给出 : I am a senior from the department of physical education   in the(对内,给校内)/a(对外) university
      2. 写作目的
   ...
   3. 第三段(两句)
      ...
      ​		I look forward to a favorable replay at your earliest convenience.
